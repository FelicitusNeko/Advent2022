...
class Main {
	...
	static function main() {
		new Main(2015, 6); // Change to (year, day) - null will default to this year/day
	}
	...
	public function new(?year:Int, ?day:Int) {
		...
		var funcMap:Map<Int, Array<AdventMakeFunc>> = [
			2015 => [
				y2015.Day1.make, y2015.Day2.make, y2015.Day3.make, y2015.Day4.make, y2015.Day5.make, y2015.Day6.make
			],
