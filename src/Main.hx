...
class Main {
	...
	static function main() {
		//new Main(2025, 2); // Change to (year, day) - null will default to this year/day
		new Main();
	}
	...
	public function new(?year:Int, ?day:Int) {
		...
		var funcMap:Map<Int, Array<AdventMakeFunc>> = [
			...
			2025 => [
				...
				y2025.Day5.make, y2025.Day6.make, y2025.Day7.make, y2025.Day8.make,
				y2025.Day9.make, y2025.Day10.make, y2025.Day11.make, y2025.Day12.make
			]
		];
